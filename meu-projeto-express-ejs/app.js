...
const produtos = [
    ...
    {id: 9, nome: "Esfoliante corporal Sephora", preco:"R$ 74,00", descricao: "O Esfoliante Corporal Sephora Collection Body Granita irá esfoliar suavemente sua pele deixando ela mais bonita, macia e delicadamente perfumada.  Floral: uma fragrância floral e doce, um devaneio de primavera em torno das flores de cerejeira.", imagem: "https://copiar--marielletom.repl.co/esfoliante.jpg"},
...
app.get('/produto/:id', (req, res) => {
  ...
  res.render('ppp', {produtoEspecifico});
});
